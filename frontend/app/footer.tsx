          ...
          <div className="flex flex-col md:flex-row justify-between gap-10 mb-12">
            ...
            <div className="flex gap-8 sm:gap-16 flex-wrap">
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="text-[#94a3b8] text-sm">📞 +94 77 217 7710</p>
                ...
                <div className="flex gap-3 mt-2">
                  ...
                  <a className="w-8 h-8 rounded-full bg-[#1e293b] flex items-center justify-center text-[#94a3b8] hover:bg-[#0ea5e9] hover:text-[#0f172a] transition-all cursor-pointer" href="https://www.linkedin.com/in/wash-xpress-1192b23b3/">
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
